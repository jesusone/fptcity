...
/**
*
* Plugin Name: DrupalExp
* Plugin URI: http://drupalexp.com
* Description: This plugin is package compilation some addons, which is developed by DrupalExp Team for Visual Comporser plugin.
* Version: 1.0.7
* Author: DrupalExp
* Author URI: http://drupalexp.com
* Copyright 2015 DrupalExp.Com. All rights reserved.
*/

define( 'ZO_NAME', 'drupalexp' );
...
class ZoThemeCore{
	...
	function zoActionInit(){
	    // Localization
	    load_plugin_textdomain(ZO_NAME, false, ZO_LANGUAGES);
	}
	...
	*/
	...
	function zo_admin_script(){
		...
		wp_enqueue_style('zotheme-font-stroke7', ZO_CSS . 'Pe-icon-7-stroke.css', array(), '1.2.0');
	}
	/**
