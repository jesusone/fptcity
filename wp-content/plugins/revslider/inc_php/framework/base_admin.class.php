<?php
 ...
 class UniteBaseAdminClassRev extends UniteBaseClassRev{
		...
		/**
		 * 
		 * set fptcity error to be shown in master view
		 */
		public static function setfptcityError($errorMessage){
			self::$fptcityError = $errorMessage;
		}
