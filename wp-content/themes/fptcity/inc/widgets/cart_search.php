...
class WC_Widget_Cart_Search extends WP_Widget {
    public function __construct() {
        parent::__construct(
            ...
            __('Cart & Search', 'fptcity'), // Name
            array('description' => __("Display the user's Cart and Search form in the sidebar.", 'fptcity'),) // Args
        );
        ...
        <div class="widget_cart_search_wrap">
            <div class="widget_cart_search_wrap_item shopping_cart_dropdown_wrap">
                ...
                <?php if($woocommerce && $show_cart):?>
                    <a href="<?php echo home_url('/cart'); ?>" class="icon icon_cart_wrap" data-display=".shopping_cart_dropdown" data-no_display=".widget_searchform_content">
                        ...
                        <div class="shopping_cart_dropdown_inner">
                            ...
                            <?php if ( sizeof( $woocommerce->cart->get_cart() ) > 0 ) : ?>
                                <div class="cart-total">
                                    ...
                                    <a href="<?php echo esc_url($woocommerce->cart->get_checkout_url()); ?>" class="btn btn-primary btn-checkout"><?php _e( 'Process To Checkout', 'fptcity'); ?></a>
                                    <a href="<?php echo esc_url($woocommerce->cart->get_cart_url()); ?>" class="btn btn-cart"><?php _e( 'View Shopping Cart', 'fptcity'); ?></a>
                                </div>
                            <?php endif; ?>
                        </div>
    ...
    function form( $instance ) {
		...
		<p>
            <label for="<?php echo esc_url($this->get_field_id('show_cart')); ?>"><?php _e( 'Show Cart:', 'fptcity' ); ?></label>
			<select id="<?php echo esc_attr($this->get_field_id('show_cart')); ?>" class="widefat" name="<?php echo esc_attr($this->get_field_name('show_cart')); ?>">
				<option value="0" <?php selected($show_cart,0); ?>><?php echo __('No','fptcity'); ?></option>
				<option value="1" <?php selected($show_cart,1); ?>><?php echo __('Yes','fptcity'); ?></option>
			</select>
        </p>
		<p>
            <label for="<?php echo esc_attr($this->get_field_id('show_search')); ?>"><?php _e( 'Show Search:', 'fptcity' ); ?></label>
			<select id="<?php echo esc_attr($this->get_field_id('show_search')); ?>" class="widefat" name="<?php echo esc_attr($this->get_field_name('show_search')); ?>">
				<option value="0" <?php selected($show_search,0); ?>><?php echo __('No','fptcity'); ?></option>
				<option value="1" <?php selected($show_search,1); ?>><?php echo __('Yes','fptcity'); ?></option>
			</select>
        </p>
    <?php
