...
class WW_News_Tabs_Widget extends WP_Widget {
    ...
    function WW_News_Tabs_Widget() {
        parent::__construct(
                'ww_news_tabs', __('ZO News Tab Widget', 'fptcity'), array('description' => __('Popular post, recent post and comments.', 'fptcity'),)
        );
    }
            ...
            <div class="tab-hold tabs-wrapper">
                <ul id="tabs" class="nav nav-tabs clearfix">
                    <?php if ($show_popular_posts == 'true'): ?>
                        <li class="active"><a href="#tab1" data-toggle="tab"><?php echo __('Popular', 'fptcity'); ?></a></li>
                    <?php endif; ?>
                    <?php if ($show_recent_posts == 'true'): ?>
                        <li><a href="#tab2" data-toggle="tab"><?php echo __('Recent', 'fptcity'); ?></a></li>
                    <?php endif; ?>
                    <?php if ($show_comments == 'true'): ?>
                        <li><a href="#tab3" data-toggle="tab"><?php echo __('Comments', 'fptcity'); ?></a></li>
                    <?php endif; ?>
                </ul>
                                ...
                                foreach ($the_comments as $comment) {
                                    ...
                                    <li>
                                        ...
                                        <div class="post-holder table-cell">
                                            ...
                                            <div class="meta">
                                                <a class="comment-text-side" href="<?php echo get_permalink($comment->ID); ?>#comment-<?php echo ''.$comment->comment_ID; ?>" title="<?php echo strip_tags($comment->comment_author); ?> on <?php echo ''.$comment->post_title; ?>"><?php echo zo_limit_words(strip_tags($comment->com_excerpt), 12); ?>...</a>
                                            </div>
                                        </div>
                                    </li>
                                <?php } ?>
