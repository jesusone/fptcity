...
class ZO_Tweets_Widget extends WP_Widget {
    ...
    function ZO_Tweets_Widget()
    {
        parent::__construct(
            'zo-tweets-widget',
            __('ZO Twitter','fptcity'),
            array('description' => __('Twitter New Status Widget.', 'fptcity'),)
        );
    }
                                        ...
                                        <li class="jtwt_tweet">
                                            ...
                                            <div class="tweet_right">
                                                ...
                                                <?php if($show_date == 'yes'): ?>
                                                    <a href="http://twitter.com/<?php echo esc_attr($tweet['user']['screen_name']); ?>/statuses/<?php echo esc_attr($tweet['id_str']); ?>" class="jtwt_date"><i class="fa fa-twitter"></i> <?php echo esc_attr($timeAgo); ?></a>
                                                <?php endif; ?>
                                            </div>
                                        </li>
                                    <?php endforeach; ?>
    ...
    function form($instance)
    {
        ...
        <p>
            ...
            <select id="<?php echo esc_attr($this->get_field_id('show_avatar')); ?>" class="widefat" name="<?php echo esc_attr($this->get_field_name('show_avatar')); ?>">
                <option value="no" <?php if($instance['show_avatar'] == 'no'){ echo "selected='selected'"; } ?>><?php echo __('No','fptcity'); ?></option>
                <option value="yes" <?php if($instance['show_avatar'] == 'yes'){ echo "selected='selected'"; } ?>><?php echo __('Yes','fptcity'); ?></option>
            </select>
        </p>
        <p>
            ...
            <select id="<?php echo esc_attr($this->get_field_id('show_date')); ?>" class="widefat" name="<?php echo esc_attr($this->get_field_name('show_date')); ?>">
                <option value="no" <?php if($instance['show_date'] == 'no'){ echo "selected='selected'"; } ?>><?php echo __('No','fptcity'); ?></option>
                <option value="yes" <?php if($instance['show_date'] == 'yes'){ echo "selected='selected'"; } ?>><?php echo __('Yes','fptcity'); ?></option>
            </select>
        </p>
        <p>
