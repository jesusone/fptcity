...
class ZO_Recent_Post_Widget_V2 extends WP_Widget {
    ...
    function ZO_Recent_Post_Widget_V2() {
        parent::__construct(
                'zo_recent_post_v2',
            __('ZO Recent Posts','fptcity'),
            array('description' => __('Recent Posts Widget.', 'fptcity'),)
        );
    }
    ...
    function widget($args, $instance) {
        ...
        $title = apply_filters('widget_title', empty($instance['title']) ? __('Recent Posts', 'fptcity' ) : $instance['title'], $instance, $this->id_base);
    ...
    function form($instance) {
        ...
        <p>
            <label for="<?php echo ''.$this->get_field_id('show_date'); ?>"><?php _e( 'Show date:', 'fptcity' ); ?></label>
        ...
        <p>
            <label for="<?php echo ''.$this->get_field_id('show_decs'); ?>"><?php _e( 'Show Description:', 'fptcity' ); ?></label>
        ...
        <p>
            <label for="<?php echo ''.$this->get_field_id('show_category'); ?>"><?php _e( 'Show Category:', 'fptcity' ); ?></label>
            <input class="widefat" id="<?php echo esc_attr( $this->get_field_id('show_category') ); ?>" name="<?php echo esc_attr( $this->get_field_name('show_category') ); ?>" <?php if($show_category!='') echo 'checked="checked";' ?> type="checkbox" value="1" />
        </p>
        <p>
