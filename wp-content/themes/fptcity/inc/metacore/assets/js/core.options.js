jQuery(document).ready(function($) {
	"use strict";
    /*Muti select postype*/
    jQuery(".zo-chosen").data("placeholder","Search Investor").chosen();
    
   
    /* multiple-field */
    $(document.body).on('change', '.zo-selectpostype select', function(e) {
        "use strict";
        var values = $(this).val();
        $(this).parent().find('.zo_select_postype').val(values.join(','));
        return;
    });
